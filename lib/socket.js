...
module.exports = function (server, database) {
    ...
    io.on('connection', (socket) => {
        // WILL NOT NEED IF 'joinChatroom' works: Add username attribute for each socket connection, must be fetched from URL from client
        socket.username = "Old Name"; // PLACEHOLDER
        ...
        socket.on('disconnect', async(reason) => {
            ...
            // The following code removes the user once diconnected from each webpage reload:
