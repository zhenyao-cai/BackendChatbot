...
class ChatBot {
    ...
    async initializePrompting() {
        this.initialQuestion = ["Hey there! I hope you're doing well. Today we will be discussing about " + this.topic + " as a group. I'd love to hear your thoughts about it.", "To start with, why don't we start by introducing ourselves!", "I'll start first, I'm " + this.botname + "I'm your GPT-powered facilitator for the discussion. I'm excited to work with all of you!", this.users[0].userName + ", do you want to go next?"] 
        /* try {
